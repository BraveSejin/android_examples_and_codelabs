...
//        .stateIn(
//            scope = viewModelScope, // stateFlow가 flow로부터 데이터를 구독받을 CoroutinScope명시
//            started = SharingStarted.WhileSubscribed(), // Flow로부터 언제부터 구독을 할 지 명
//            initialValue = listOf() // StateFlow에 저장될 초기값 설정
//        )
